...
declare class Selection {
  ...
  on<E extends keyof SelectionEvents>(
    ev: E,
    cb: SelectionEvents[E],
  ): this;

  off<E extends keyof SelectionEvents>(
    ev: E,
    cb: SelectionEvents[E],
  ): this;
  ...
  select(
    query: Parameters<Selection.SelectionUtils['selectAll']>[0],
  ): Element[];
}
